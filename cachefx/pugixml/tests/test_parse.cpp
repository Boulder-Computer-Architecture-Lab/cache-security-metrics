...
TEST_XML_FLAGS(parse_embed_pcdata_fragment, "text",
...
TEST_XML_FLAGS(parse_embed_pcdata_child, "<n><child/>text</n>",
               parse_embed_pcdata) {
...
TEST_XML_FLAGS(parse_embed_pcdata_comment, "<n>text1<!---->text2</n>",
               parse_embed_pcdata) {
  xml_node n = doc.child(STR("n"));
