...
public:
  ...
  uint32_t getAccessTime(int32_t way) const { return entries[way].accessTime; };
  void setAccessTime(int32_t way, uint32_t accessTime) {
    entries[way].accessTime = accessTime;
  };
