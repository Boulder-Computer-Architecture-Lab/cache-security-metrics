...
enum VictimType { VT_INVALID, VT_AES, VT_SQUAREMULT, VT_SINGLE, VT_BINARY };
...
enum AttackerType { AT_INVALID, AT_OCCUPANCY, AT_EVICTION };
enum ProbeType { PT_ATTACKER, PT_LAST, PT_VICTIM };
enum AccessType { ACT_ALL, ACT_TARGET, ACT_FIVE, ACT_TEN, ACT_FIFTEEN };
enum NoiseType { NT_SEPARATE, NT_SAME, NT_PROBE_SIZE };
